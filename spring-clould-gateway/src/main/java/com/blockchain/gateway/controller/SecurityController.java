...
public class SecurityController {
  ...
  public Mono<OpResult> login(@RequestParam String loginName, @RequestParam(required = false) Long weId, @RequestParam String password, @RequestParam String clientVersion) {
    OpResult opResult = new OpResult();
    final Mono<SecurityUser> authentication = securityService.authenticate(loginName, weId, password);
